...
export declare type ChatUnfurlArguments = (ChannelAndTSArguments | SourceAndUnfurlIDArguments) & WebAPICallOptions & TokenOverridable & {
    /**
...
export declare type FileUploadV2 = FileUpload & {
    alt_text?: string;
    channel_id?: string;
    snippet_type?: string;
};
